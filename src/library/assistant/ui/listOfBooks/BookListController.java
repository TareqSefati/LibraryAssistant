package library.assistant.ui.listOfBooks;
...
public class BookListController implements Initializable {
    ...
    private void initCol() {
        ...
        availabilityCol.setCellValueFactory(new PropertyValueFactory<>("availablity"));
    }
    ...
    private void loadData() {
        ...
        try {
            while(results.next()){
                ...
                Boolean avail = results.getBoolean("isAvail");
    ...
    public static class Book {
        ...
        public Book(String title, String id, String author, String publisher, Boolean avail){
            ...
            this.availablity = new SimpleBooleanProperty(avail);
        }
